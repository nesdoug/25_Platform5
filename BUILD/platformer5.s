...
;
	jmp     L06CB
L09C7:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L06CB:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
	...
	sec
	sbc     _eject_R
L09CC:	sta     _BoxGuy1+1
;
; if(BoxGuy1.vel_y < 0x300){
;
L06F5:	lda     _BoxGuy1+6
	cmp     #$00
	lda     _BoxGuy1+6+1
	sbc     #$03
	bvc     L06FF
...
;
L07E0:	ldy     _coordinates
	lda     _c_map2,y
L09E2:	sta     _collision
;
